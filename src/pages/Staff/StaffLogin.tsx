...
import { User, LogIn, AlertCircle, Eye, EyeOff, Users } from 'lucide-react';
...
export default function StaffLogin() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-blue-900 to-emerald-900 flex items-center justify-center p-4">
