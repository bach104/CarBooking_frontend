...
export default function BookRide() {
  ...
  // FIXED: Debounced fetch suggestions
    ...
    try {
      const bookingData = {
        customer: {
          ...
          email: formData.customer.email && formData.customer.email.trim() !== '' ? formData.customer.email : undefined
        },
        booking: {
          ...
          <div className="p-8 md:p-12">
            {step === 1 && (
              <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      {vehicleTypes.map(type => (
                        <button
                          ...
                          className={`p-5 rounded-3xl border-2 text-left transition-all ${formData.booking.seats === type.seats ? 'border-emerald-500 bg-emerald-50 shadow-lg shadow-emerald-100' : 'border-gray-50 hover:border-gray-200 bg-white'}`}
                        >
                ...
                <div className="h-96 lg:h-auto min-h-400 rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-inner relative">
              ...
              <div className="max-w-2xl mx-auto space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <button 
                    ...
                    className="flex-2 bg-emerald-500 hover:bg-emerald-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white py-5 rounded-2xl font-black uppercase tracking-widest text-sm transition-all shadow-xl shadow-emerald-100"
                  >
                    Tiếp Theo
                  </button>
                </div>
              ...
              <div className="max-w-2xl mx-auto space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <button 
                    ...
                    disabled={loading}
                    className="flex-2 bg-emerald-500 hover:bg-emerald-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white py-5 rounded-2xl font-black uppercase tracking-widest text-sm flex items-center justify-center gap-2 transition-all shadow-xl shadow-emerald-200"
                  >
